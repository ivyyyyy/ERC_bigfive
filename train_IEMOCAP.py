...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        textf, visuf, acouf, bigfive, qmask, umask, label =\
        ...
        log_prob, alpha, alpha_f, alpha_b, loss = model(textf, qmask, umask, bigfive, labels_intput, att2=True) # seq_len, batch, n_classes
...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam([
                            {'params': base_params},
                            {'params': model.crf.parameters(), 'lr':args.lr * 10000}
                        ], lr=args.lr, weight_decay=args.l2)

    train_loader, valid_loader, test_loader =\
            get_IEMOCAP_loaders('../data/DialogueRNN_features/IEMOCAP_features/IEMOCAP_features_bigfive.pkl',
                                valid=0.0,
                                batch_size=batch_size,
                                num_workers=2)
